...
- In [Bot Framework Emulator][BFE], a card is generated with the suggestions.
  ...
  - `ACTIVE_LEARNING_CARD_TITLE`, `ACTIVE_LEARNING_CARD_NO_MATCH_TEXT` and `ACTIVE_LEARNING_CARD_NO_MATCH_RESPONSE` in the card could be changed from [qnamakerBaseDialog.js](dialogs/qnamakerBaseDialog.js).
...
- You can set `INCLUDE_UNSTRUCTURED_SOURCES` to false in [qnamakerBaseDialog.js](dialogs/qnamakerBaseDialog.js) to prevent querying unstructured sources.
...
- You can filter answers using bot as well by passing metadata and/or source filters. Edit line no. 54 in [qnamakerBaseDialog.js](dialogs/qnamakerBaseDialog.js) to something like below. [Learn more](https://docs.microsoft.com/en-us/rest/api/cognitiveservices/questionanswering/question-answering/get-answers#queryfilters).
    ```js
